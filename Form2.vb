Public Class Form2
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        For ii As Integer = 8 To y.Length Step 8
            ...
            For i As Integer = 0 To 7
                    If Expo.Chars(i) = k1.Chars(i) Then
                        rr &= "0"
                    Else
                        rr &= "1"
                    End If
            ...
            p4 = (cont.Chars(1) & cont.Chars(3) & cont.Chars(2) & cont.Chars(0))
                ...
                For j As Integer = 0 To 7
                    If Expo.Chars(j) = k2.Chars(j) Then
                        rr1 &= "0"
                    Else
                        rr1 &= "1"
                    End If
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        For Each myChar As Byte In System.Text.ASCIIEncoding.ASCII.GetBytes(t1.Text)
            strBuilder.Append(Convert.ToString(myChar, 2).PadLeft(8, "0"))
            strBuilder.Append("")

        Next
        tmp = strBuilder.ToString.Substring(0, strBuilder.ToString.Length - 1)
        t5.Text = tmp
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        Dim writer As New System.IO.StreamWriter("C:\Folder\Binary.txt")
